module.exports.config = {
	...
	hasPermssion: 0,
	credits: "Vtuan",
	description: "Random ảnh nude hana",
...
module.exports.run = async ({ api, event ,Users}) => {
	...
	const fs = require("fs");
    var array = [];
    const res1 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
    const res2 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
    const res3 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
    const res4 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
    const res5 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
    const res6 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/hana`);
