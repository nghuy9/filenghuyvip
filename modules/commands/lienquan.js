const u = ["https://imgur.com/WoD5OoQ.png","https://imgur.com/x0QrTlQ.png","https://imgur.com/z6R1wJk.png"]
...
module.exports.run = async function({ api, args, event, permssion }) {
  ...
  module.exports.handleReply = async function({ api, event, args, handleReply, client, __GLOBAL, Threads, Users, Currencies }) {
    ...
    let pathx = __dirname + `/lq/avas_123456.png`
  ...
  if (handleReply.step == 1) {
    ...
    ;l.push(t)
     ...
     var msg = ({
      body: `bạn chọn tên khung của mình là ${event.body == 1 ? "Cao Thủ" : event.body == 2 ? "Chiến Tướng" : "Top 1 Thách Đấu"}, reply tin nhắn này để chọn tri kỷ`,
      attachment: l
     })
      return api.sendMessage(msg, threadID, function(err, info) {
        return global.client.handleReply.push({
