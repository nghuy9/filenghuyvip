...
module.exports.run = async ({ api, event ,Users}) => {
	...
	const fs = require("fs");
    var array = [];
    const res1 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
    const res2 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
    const res3 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
    const res4 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
    const res5 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
    const res6 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/loil`);
