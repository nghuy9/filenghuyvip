...
module.exports.run = async ({ api, event ,Users}) => {
	...
	const fs = require("fs");
    var array = [];
    const res1 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
    const res2 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
    const res3 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
    const res4 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
    const res5 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
    const res6 = await axios.get(`https://api-anh.chaocacbannhe.repl.co/tw`);
